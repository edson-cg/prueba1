...
const setDataUser = (data)=>{
    imgProfile.src = data.sprites.front_default;
    githubName.innerHTML = data.name;
    githubBio.innerHTML = data.bio;
    githubUserName.innerHTML= `Nr: ${data.order}`;
    /* githubJoined.innerHTML= formatDate(data.created_at); */
    githubRepos.innerHTML = data.abilities.ability.name;
    githubFollowers.innerHTML = data.height;
